...
describe("Triangle SSS", () => {
    ...
    it("Test angle", () => {
        const triangle = new Triangle(7, 8, 6);
        expect(triangle.getAngleA()).toBeCloseTo(46.5, 0.5);
        expect(triangle.getAngleB()).toBeCloseTo(57.9, 0.5);
        expect(triangle.getAngleC()).toBeCloseTo(75.5, 0.5);
        ...
        expect(triangle3.getAngleA()).toBeCloseTo(90, 0.5);
        expect(triangle3.getAngleB()).toBeCloseTo(36.8, 0.5);
        expect(triangle3.getAngleC()).toBeCloseTo(53.1, 0.5);
    });
});